...
<div class="report-header">
					<h1 class="recent-Articles">Add video Form</h1>
...
<form action="/video" method="post">
    ...
    <table border='2'>
		...
		<td><input type="text" id="vtitle" name="vtitle" required></td>
        </tr>
        <tr>
		<td><label for="userdob">video Type</label></td>
		<td><input type="text" id="vtype" name="vtype" required></td>
        </tr>
        <tr>
		<td><label for="usercontact">video path</label></td>
		<td><input type="text" id="vpath" name="vpath" required></td>
        </tr>
        <tr>
